...
배율: 평균순위 나쁠수록 크게(≥4→1.4 / 3~4→1.3 / 2~3→1.2). 상한 100,000원.
...
# ── 적용 대상: (캠페인, 그룹, 키워드, 배율) — 전환기준 91개 ──────────
PLAN = [
    ('B.일반형사', '00.형사', '형사변호사', 1.4),
    ('B.일반형사', '00.형사', '형사사건변호사', 1.4),
    ('B.일반형사', '00.형사', '형사소송', 1.2),
    ('B.일반형사', '00.형사', '형사고소', 1.2),
    ('B.일반형사', '00.형사', '형사합의금', 1.2),
    ('B.일반형사', '00.형사', '형사처벌', 1.3),
    ('B.일반형사', '00.형사', '형사고소비용', 1.2),
    ('B.일반형사', '00.형사', '형사항소기간', 1.4),
    ('B.일반형사', '00.형사', '형사소송상담', 1.3),
    ('B.일반형사', '02.형사_지역', '수원검찰조사변호사', 1.2),
    ('B.일반형사', '02.형사_지역', '수원변호사선임', 1.4),
    ('B.일반형사_항시', '04.배임횡령_세부_항시', '횡령전문변호사상담', 1.2),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '횡령처벌', 1.4),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '횡령죄처벌', 1.4),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '배임죄고소', 1.4),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '배임죄형량', 1.3),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '배임죄처벌', 1.4),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '공금횡령죄형량', 1.4),
    ('B.일반형사_항시', '04.배임횡령_정보_항시', '업무상횡령처벌', 1.3),
    ('B.일반형사_항시', '04.배임횡령_주력_항시', '횡령죄전문변호사', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '업무상횡령죄', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '업무상횡령', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '업무상배임죄', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '배임수재죄', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '공금횡령죄', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '배임죄', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '횡령죄', 1.4),
    ('B.일반형사_항시', '04.배임횡령_항시', '점유이탈물횡령죄', 1.3),
    ('B.일반형사_항시', '04.배임횡령_항시', '점유물이탈횡령죄', 1.4),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '위증죄고소', 1.2),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '위증죄처벌', 1.3),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고처벌', 1.2),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고죄고소', 1.4),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고죄합의금', 1.4),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고죄벌금', 1.4),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고죄형량', 1.4),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고죄성립요건', 1.3),
    ('B.일반형사_항시', '06.위조,위증,무고_정보_항시', '무고죄처벌', 1.4),
    ('B.일반형사_항시', '06.위조,위증,무고_항시', '위증죄', 1.3),
    ('B.일반형사_항시', '06.위조,위증,무고_항시', '무고', 1.3),
    ('B.일반형사_항시', '06.위조,위증,무고_항시', '무고죄', 1.3),
    ('B.일반형사_항시', '07.업무방해_정보_항시', '업무방해죄벌금', 1.2),
    ('B.일반형사_항시', '07.업무방해_정보_항시', '업무방해죄형량', 1.3),
    ('B.일반형사_항시', '07.업무방해_정보_항시', '영업방해죄벌금', 1.2),
    ('B.일반형사_항시', '07.업무방해_정보_항시', '영업방해죄처벌', 1.4),
    ('B.일반형사_항시', '07.업무방해_주력_항시', '영업방해변호사', 1.2),
    ('B.일반형사_항시', '07.업무방해_항시', '업무방해죄', 1.4),
    ('B.일반형사_항시', '07.업무방해_항시', '영업방해죄', 1.4),
    ('B.일반형사_항시', '08.식품위생법_항시', '식품위생법위반', 1.4),
    ('B.일반형사_항시', '08.식품위생법_항시', '식품위생법', 1.2),
    ('C.폭행', '01.폭행', '폭행', 1.4),
    ('C.폭행', '01.폭행', '폭행죄', 1.3),
    ('C.폭행', '01.폭행', '특수폭행', 1.2),
    ('C.폭행', '01.폭행', '쌍방폭행', 1.3),
    ('C.폭행', '01.폭행', '폭행변호사상담', 1.3),
    ('C.폭행', '01.폭행', '폭행변호사비용', 1.2),
    ('C.폭행', '01.폭행', '데이트폭력', 1.2),
    ('C.폭행', '01.폭행', '폭행죄벌금', 1.4),
    ('C.폭행', '02.폭행_정보', '폭행합의금', 1.3),
    ('C.폭행', '02.폭행_정보', '폭행재판', 1.2),
    ('C.폭행', '02.폭행_정보', '쌍방폭행벌금', 1.2),
    ('C.폭행', '02.폭행_정보', '쌍방폭행재판', 1.2),
    ('D.상해', '01.상해', '상해', 1.4),
    ('D.상해', '01.상해', '특수상해죄', 1.4),
    ('D.상해', '02.상해_정보', '상해변호사비용', 1.2),
    ('D.상해', '02.상해_정보', '상해변호사상담', 1.2),
    ('F.성범죄_신규', '01.성범죄', '성추행변호사수임료', 1.4),
    ('F.성범죄_신규', '03.아청법', '청소년성범죄피해자변호사', 1.2),
    ('F.성범죄_항시_신규', '01.성범죄_정보_항시', '성추행공소시효', 1.4),
    ('F.성범죄_항시_신규', '01.성범죄_지역_화성_항시', '동탄성범죄변호사', 1.4),
    ('F.성범죄_항시_신규', '01.성범죄_지역_화성_항시', '동탄성범죄전문변호사', 1.4),
    ('F.성범죄_항시_신규', '04.디지털성범죄_변호사_항시', '통매음변호사', 1.4),
    ('F.성범죄_항시_신규', '04.디지털성범죄_변호사_항시', '카촬죄변호사추천', 1.3),
    ('F.성범죄_항시_신규', '04.디지털성범죄_변호사_항시', '통매음전문로펌', 1.2),
    ('F.성범죄_항시_신규', '04.디지털성범죄_변호사_항시', '사이버성범죄전문변호사', 1.2),
    ('F.성범죄_항시_신규', '04.디지털성범죄_상담_항시', '딥페이크변호', 1.3),
    ('F.성범죄_항시_신규', '04.디지털성범죄_소송_항시', '카촬죄고소', 1.4),
    ('F.성범죄_항시_신규', '04.디지털성범죄_소송_항시', '통매음고소', 1.4),
    ('F.성범죄_항시_신규', '04.디지털성범죄_정보_항시', '롤통매음고소', 1.2),
    ('F.성범죄_항시_신규', '04.디지털성범죄_정보_항시', '음란물기준', 1.2),
    ('F.성범죄_항시_신규', '04.디지털성범죄_지역_강남_항시', '강남디지털성범죄변호사', 1.2),
    ('F.성범죄_항시_신규', '04.디지털성범죄_지역_수원_항시', '수원사이버성범죄전문변호사', 1.2),
    ('F.성범죄_항시_신규', '06.미성년자의제강간_정보', '미성년자성범죄합의금', 1.2),
    ('G.금융_1117 (신채널)', '15.사기_조합_1117', '사기죄형량', 1.2),
    ('G.금융_1117 (신채널)', '15.사기_조합_1117', '사기죄성립요건', 1.3),
    ('G.금융_1117 (신채널)', '16.사기_주력_1117', '사기전문변호사', 1.4),
    ('G.금융_1117 (신채널)', '16.사기_주력_1117', '로맨스스캠변호사', 1.4),
    ('H.보이스피싱_1117 (신채널)', '01.보이스피싱_1117', '보이스피싱당했을때', 1.2),
    ('H.보이스피싱_1117 (신채널)', '01.보이스피싱_1117', '보이스피싱상담센터', 1.2),
    ('H.보이스피싱_1724 (신채널)', '01.보이스피싱_1724', '통장양도변호사', 1.2),
    ('A.메인_1117', '00.순위MO_1117', '변호사', 1.2),
]
